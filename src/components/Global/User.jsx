...
export default function UserPage({ data }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      isPrivate: data.gender === undefined,
      isEmpty: data.gender === null,
      value: genders?.[data.gender]?.pronouns || "Special",
      icon: "fas fa-venus-mars",
    },
    {
      upper: true,
      name: "About Me",
      subtitle: "Who am I?",
      isPrivate: data.about === undefined,
      isEmpty: data.about === null,
      value: data.about,
  ...
  return (
    <>
      {user?.styles && <style>{user.styles}</style>}
      <NextSeo
      ...
      <div className="flex flex-col items-center justify-center px-10 3xl:px-0">
        <div className="max-w-7xl w-full">
          <div id="user-header" className="mb-12">
            ...
            <div
              id="user-info"
              className="lg:pl-16 pr-0 flex flex-col lg:flex-row items-center gap-6"
            >
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between w-full">
                ...
                <div className="flex items-center justify-center lg:justify-end gap-4 w-full lg:w-2/4">
                  <Tooltip
                    content={"You must be logged in to like this user."}
                    disabled={user !== null}
                  >
                    <div>
                      <Button
            ...
            {cards
              ...
              .map((card, i) => {
                return (
                  <div
                    key={i}
                    className="p-4 px-6 bg-light dark:bg-dark rounded-lg dark:shadow-lg w-full"
                  >
            ...
            <div className="p-4 px-6 bg-light dark:bg-dark rounded-lg dark:shadow-lg w-full">
              <div className="flex items-center gap-4 mb-4">
                <div className="flex-shrink-0">
                  <i
                    className={
                      "fa fa-wand-magic-sparkles text-4xl text-primary"
                    }
                  />
                </div>
                <div className="flex flex-col justify-center">
                  ...
                  {data?.socials.map((social, i) => {
                    return (
                      ...
                      >
                        ...
                        <i
                          className={"fas fa-external-link-alt text-zinc-500"}
                        />
                      </a>
                    );
                  })}

          ...
          <div className="w-full bg-light dark:bg-dark rounded-lg overflow-hidden select-none p-4">
            <div>
              <div className="flex items-center justify-start gap-2">
                ...
                <div>
                  <h1 className="text-black dark:text-white text-lg font-medium">
                    {username}
                    {isVerified && <i className="fas fa-badge-check ml-1.5" />}
                  </h1>
              ...
              <div className="flex justify-start items-center gap-2 w-full mt-6">
                <p className="text-sm text-black/75 dark:text-gray-500 font-medium line-clamp-3 h-16 overflow-hidden text-left">
                  {about}
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-end items-center w-full mt-4 gap-4">
              <Link href={`/profile/${url}`} legacyBehavior={true}>
              ...
              <Button
                onClick={toggleLike}
                className="!px-0 !w-12 h-12 flex justify-center items-center flex-shrink-0"
                color="red"
                variant="ghost"
              >
